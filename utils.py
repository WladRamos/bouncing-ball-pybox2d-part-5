...
class Utils():
    ...
    def __init__(self):
        ...
        # Define a altura base da tela
        self.height = 1000  # Pode ser ajustado conforme necessário
        
        # Calcula a largura mantendo a proporção 9:16
        self.width = int(self.height * (9 / 16))

        # Inicializa a tela do pygame com a nova proporção
...
utils = Utils()  # Criando um objeto global de Utils
